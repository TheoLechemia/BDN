...
def buildGeojsonWithParams(res):
    ...
    for r in res:
        ...
        if r[9] == True:
            mypropertiesPoint = {'nom_vern': r[4], 'lb_nom':r[2], 'cd_nom': r[3], 'date': date, 'projet': r[6], 'observateur': r[10], 'id_synthese': r[1], 'id' : r[1],
                                 'producteur': r[11], 'precision': r[12], 'ccod_frt': r[13], 'altitude': r[14], 'valide': r[15], 'diffusable': r[16]}
            try:
            ...
            myPropertiesMaille = {'nom_vern': r[4], 'lb_nom':r[2], 'cd_nom': r[3], 'date': date, 'projet': r[6], 'observateur': r[10], 'id_synthese': r[1], 'id' : r[8],
             'producteur': r[11], 'precision': r[12], 'ccod_frt': r[13], 'altitude': r[14], 'valide': r[15], 'diffusable': r[16]}
            try:
