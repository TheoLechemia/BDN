...
(4,'type_obs', 'Nid', 'spec_1'),
(5,'type_obs', 'Gîte', 'spec_1'),
(6,'type_obs', 'Nichoir', 'spec_1'),
(7,'type_obs', 'Empreintes, traces', 'spec_1'),
(8,'type_obs', 'Détection', 'spec_1'),
(9,'type_obs', 'Capture manuelle', 'spec_1'),
...
(4,'nb_pied_approx', 'Plus de 100','spec_3'),
(1,'stade_dev', 'Stade végétatif','spec_3'),
